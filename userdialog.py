...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.checkBox_4Dto3D.setGeometry(QRect(20, 190, 291, 20))
...
"After clicking OK below, please click \"Start with MRI tags\" to enter your anatomic regions and MRID islands.", None))
        self.checkBox_4Dto3D.setText(QCoreApplication.translate("Dialog", u"I want to open the 4D volume as 3D volume at t=0", None))
